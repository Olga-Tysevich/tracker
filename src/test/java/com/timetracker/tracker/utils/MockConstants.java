...
public class MockConstants {
    ...
    public static final String GET_PROJECTS_ENDPOINT = "/project/get";
    public static final String GET_RECORDS_FOR_ADMIN_ENDPOINT = "/record/admin/get";
    public static final String GET_RECORDS_FOR_USER_ENDPOINT = "/record/get";
    public static final String CREATE_USER_FOR_ADMIN_ENDPOINT = "/user/admin/create";
    public static final String CREATE_PROJECT_FOR_ADMIN_ENDPOINT = "/project/admin/create";
    public static final String CREATE_RECORD_ENDPOINT = "/record/create";
    public static final String GET_CURRENT_USER_ENDPOINT = "/user";
    public static final String UPDATE_USER_ENDPOINT = "/user/update";
    public static final String UPDATE_PROJECT_ENDPOINT = "/project/admin/update";
    public static final String UPDATE_RECORD_ENDPOINT = "/record/update";
    public static final String DELETE_USER_ENDPOINT = "/user/admin/delete";
    public static final String DELETE_PROJECT_ENDPOINT = "/project/admin/delete";
    public static final String DELETE_RECORD_ENDPOINT = "/record/delete";
    ...
    public static final String PROJECTS_FOR_PAGE_SCHEME = "/projects_for_page.json";
    public static final String RECORDS_FOR_PAGE_SCHEME = "/records_for_page.json";
    ...
    public static final int DEFAULT_NUMBER_OF_OBJECTS = 10;
